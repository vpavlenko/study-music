...
Анализируем аккорды, мелодию и форму. Возьмите любой трэк из simple major. 

1) Найдите оригинал, проверьте, насколько близко эта аранжировка на него похожа.
2) Правда ли, что трэк устроен как "аккорды снизу + мелодия сверху", или есть отклонения?
3) Каким рисунком реализиуются аккорды? Какие аккорды в каждом такте? Как часто они меняются?
5) Как устроена мелодия - есть ли в ней мотив, который развивается? Как это происходит? (Например, ритм остается тем же, ноты смещаются на одну вверх по гамме)
6) Как мелодия соотносится с нотами аккорда?
7) Как устроены большие повторения (форма) - начальный кусок в 4-8 тактов потом повторяется ещё сколько-то раз? Где вводится новый материал (аккорды или мелодия), как он соотносится с первой частью?

Тщательно разберите один трэк. Если останется время - посмотрите и другие. В конце расскажите нам свой анализ.

Можно взять любой другой трэк c [musescore](https://musescore.com/sheetmusic) или с https://chiptune.app/ или из midi-файлов из интернета - пришлите мне ссылку в лс, добавлю.
