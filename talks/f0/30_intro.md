...
Анализируем гармонию и форму. Возьмите любой трэк из simple major. 
...
4) Как устроена мелодия - есть ли в ней мотив, который развивается? Как это происходит? (Например, ритм остается тем же, ноты смещаются на одну вверх по гамме)
5) Как устроены большие повторения (форма) - начальный кусок в 4-8 тактов потом повторяется ещё сколько-то раз? Где вводится новый материал (аккорды или мелодия), как он соотносится с первой частью?
