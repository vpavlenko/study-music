...
2. Определяем начальные такты всех частей формы: intro, verse, chorus, bridge, solo, outro. Чтобы надписать их, в режиме (x)Merged [x]Analysis кликаем на такт и выбираем 
