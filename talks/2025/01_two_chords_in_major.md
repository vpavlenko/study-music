...
- Возьмите код вальса 25 за основу. Придумайте другую мелодию, используя идеи из остальных вальсов (мотивы, ритмы, повторения). Закодируйте новую мелодию и пришлите мне полный код.
