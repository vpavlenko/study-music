...
- Chinese language is not very random, many sequence of characters sounds good, it doesn't have any meaning, and we don't need to know anything about its structure. There are people who speak Chinese, we'll only use them at the evaluation stage by politely showing our generated music and ask them to review. (Music theory doesn't exist and should not be studied, at all.)
